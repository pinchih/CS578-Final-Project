...
do
	...
	java -Xmx512M -cp soot.jar:soot-infoflow.jar:soot-infoflow-android.jar:slf4j-api-1.7.5.jar:slf4j-simple-1.7.5.jar:axml-1.0.jar soot.jimple.infoflow.android.TestApps.Test "$file" "$adt"  $params> "../$output/${fileName[5]}.txt"
	END=$(date +%s)
	DIFF=$(( $END - $START ))
